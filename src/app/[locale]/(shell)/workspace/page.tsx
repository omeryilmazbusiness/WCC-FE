  ...
  return (
    <Screen>
      ...
      <div className="grid gap-5 lg:grid-cols-2">
        <section className="group rounded-[24px] border border-zinc-200/70 bg-white p-6 shadow-[0_12px_36px_-22px_rgba(15,23,42,0.22)] transition-all duration-300 hover:-translate-y-1 hover:border-zinc-300 hover:shadow-[0_16px_40px_-22px_rgba(15,23,42,0.3)] sm:p-7">
